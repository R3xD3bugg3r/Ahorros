...
import { Plus, X, TrendingDown, TrendingUp, Loader2 } from 'lucide-react'
                ...
                <div className="fixed inset-0 z-50 flex flex-col justify-end">
                    ...
                    <div className="relative glass rounded-t-3xl p-6 pb-safe max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {/* Description */}
                            <div className="space-y-1.5">
                                <Label htmlFor="desc">Descripción <span className="text-slate-500 font-normal">(opcional)</span></Label>
                                <Input id="desc" placeholder="Ej: Café en Starbucks" value={description} onChange={e => setDescription(e.target.value)} />
                            </div>
